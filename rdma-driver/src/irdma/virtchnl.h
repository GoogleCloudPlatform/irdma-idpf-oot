...
#define IRDMA_VCHNL_OP_GET_MULTI_QS_V0 0
#define IRDMA_VCHNL_OP_GET_RDMA_CAPS_V1 1
...
struct irdma_vchnl_req_multi_qs_info {
	u16 vport_id;
};

struct irdma_qs_entry {
	u8 qs_cnt;
	u16 qs_handle[IRDMA_MAX_QSETS];
};

struct irdma_vchnl_resp_multi_qs_info {
	u8 dist_mode;
	struct irdma_qs_entry qs_entry[IRDMA_MAX_USER_PRIORITY];
};

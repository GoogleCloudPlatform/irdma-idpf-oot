...
/* Veloce */
#define MEV_B0_34		0x0034
#define MEV_B0_37		0x0037
#define MEV_B0_39		0x0039
#define MEV_C0_45		0x0045
#define MMG_DEV_00		0x0060
/* Silicon */
#define NRB_A0_04	0x0a04
#define NRB_B0		0x0b00
#define NRB_C0		0x0c00
/* Simics */
#define SIMICS_42	13

/* Add following defines for mev hw/fw work arounds. Theses are
 * going to be bit value saved in struct irdma_sc_dev field of hw_wa.
 */
#define CCQ_CQ3_POLL		0x1
#define AEQ_POLL		0x2
#define CEQ_POLL		0x4
#define TIMER_NEEDED (CCQ_CQ3_POLL | AEQ_POLL | CEQ_POLL)
#define NO_CQACK		0x10
#define NO_CEQMASK		0x20
#define NO_LPB			0x80
#define IGNORE_OOO		0x100
#define MAX_QP_2K		0x200
#define RQ_PREFETCH_EN		0x400
#define RSRC_MNGMT_LMTS		0x800
#define ATOMICS_OPS		0x1000
#define SIMICS_RCA		0x2000		/* Simics-only */
#define REDUCE_ORD_IRD		0x8000
#define NO_STAG0		0x10000
#define LOC_MEM_WA		0x20000
#define NO_FLUSH		0x40000
#define CQ_NO_CHECKFLOW		0x80000
#define STAG_ACC_RIGHTS		0x100000	/* Simics-only */
#define CQP_COMPL_WAIT		0x200000	/* Simics-only */
#define MSIX_SHARED		0x400000	/* Simics-only */
#define REDUCE_ORD_IRD_SIMICS	0x800000	/* Simics-only */
#define FORCE_LPB		0x1000000
#define NO_INTR			0x2000000
#define MMG_WA			0x4000000
#define DEFUNCT_CQ_WA		0x8000000

#define IRDMA_MAX_MEV_QPCNT	(1024 * 1024)
...
#define IRDMA_CQP_TYPE_PRIMARY	0
#define IRDMA_CQP_TYPE_RCA	1
#define IRDMA_CQP_TYPE_RCP	2
#define IRDMA_CQP_TYPE_RSVD	3
...
#define IRDMA_MAX_STATS_COUNT_GEN1	12
...
#define IRDMA_CQP_SW_RQSIZE_4		4
#define IRDMA_CQP_SW_RQSIZE_2048	2048
...
#define IRDMA_ATOMICS_ALLOWED_BIT	(1 << 0)
#define MANAGE_RESOURCE_VER2_BIT	(1 << 2)
#define HW_FLUSH_TIMER_DISABLE_BIT	(1 << 3)
...
enum irdma_cqp_op_type {
	...
	IRDMA_OP_WS_MOVE			= 49,
	IRDMA_OP_SRQ_CREATE			= 50,
	IRDMA_OP_SRQ_MODIFY			= 51,
	IRDMA_OP_SRQ_DESTROY			= 52,
	IRDMA_OP_GATHER_RDMA_SYSTEM_STATS       = 57,
	IRDMA_OP_RCA_EXEC_FWD_OP		= 58,
	IRDMA_OP_RET_CQP_CMPL			= 59,
	IRDMA_OP_NOP				= 60,
	IRDMA_OP_COPY_DATA			= 61,
	IRDMA_MAX_CQP_OPS			= 62,
};
...
#define IRDMA_CQP_OP_MANAGE_PBLE_BP			0x10
...
#define IRDMA_CQP_OP_RET_CQP_CMPL			0x33
#define IRDMA_CQP_OP_COPY_DATA				0x35
#define IRDMA_CQP_OP_GATHER_RDMA_SYS_STATS		0x34
...
#define IRDMA_CQPSQ_STATS_HMC_FCN_CNT_S 16
#define IRDMA_CQPSQ_STATS_HMC_FCN_CNT GENMASK_ULL(20, 16)
#define IRDMA_CQPSQ_STATS_INST_INDEX_S 0
#define IRDMA_CQPSQ_STATS_INST_INDEX GENMASK_ULL(15, 0)
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX1_S 16
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX1 GENMASK_ULL(31, 16)
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX2_S 32
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX2 GENMASK_ULL(47, 32)
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX3_S 48
#define IRDMA_CQPSQ_STATS_HMC_FCN_INDEX3 GENMASK_ULL(63, 48)
...
#define IRDMA_CQPSQ_WS_WS_OP_TYPE_S 60
#define IRDMA_CQPSQ_WS_WS_OP_TYPE GENMASK_ULL(61, 60)
#define IRDMA_CQPSQ_WS_LNG_ID_S 32
#define IRDMA_CQPSQ_WS_LNG_ID GENMASK_ULL(44, 32)
#define IRDMA_CQPSQ_WS_RATE_LIMIT_FLAGS_S 24
#define IRDMA_CQPSQ_WS_RATE_LIMIT_FLAGS GENMASK_ULL(28, 24)
#define IRDMA_CQPSQ_WS_RATE_S 0
#define IRDMA_CQPSQ_WS_RATE GENMASK_ULL(19, 0)
#define IRDMA_SD_MAX_S 0
#define IRDMA_SD_MAX GENMASK_ULL(15, 0)
#define IRDMA_MEM_MAX_S 0
#define IRDMA_MEM_MAX GENMASK_ULL(15, 0)
#define IRDMA_QP_MEM_LOC_S 44
...
#define IRDMA_CQPHC_TIMESTAMP_OVERRIDE_S 5
#define IRDMA_CQPHC_TIMESTAMP_OVERRIDE BIT_ULL(5)
#define IRDMA_CQPHC_TS_SHIFT_S 8
#define IRDMA_CQPHC_TS_SHIFT GENMASK_ULL(12, 8)
#define IRDMA_CQPHC_EN_FINE_GRAINED_TIMERS_S 0
#define IRDMA_CQPHC_EN_FINE_GRAINED_TIMERS BIT_ULL(0)

#define IRDMA_CQPHC_RQSIZE_S 16
#define IRDMA_CQPHC_RQSIZE GENMASK_ULL(19, 16)
#define IRDMA_CQPHC_CQP_TYPE_S 12
#define IRDMA_CQPHC_CQP_TYPE GENMASK_ULL(13, 12)

#define IRDMA_CQPHC_OOISC_BLKSIZE_S 60
#define IRDMA_CQPHC_OOISC_BLKSIZE GENMASK_ULL(63, 60)
#define IRDMA_CQPHC_RRSP_BLKSIZE_S 56
#define IRDMA_CQPHC_RRSP_BLKSIZE GENMASK_ULL(59, 56)
#define IRDMA_CQPHC_Q1_BLKSIZE_S 52
#define IRDMA_CQPHC_Q1_BLKSIZE GENMASK_ULL(55, 52)
#define IRDMA_CQPHC_XMIT_BLKSIZE_S 48
#define IRDMA_CQPHC_XMIT_BLKSIZE GENMASK_ULL(51, 48)
#define IRDMA_CQPHC_BLKSIZES_VALID_S 4
...
#define IRDMA_CCQ_DEFINFO_S 32
#define IRDMA_CCQ_DEFINFO GENMASK_ULL(63, 32)

#define IRDMA_CQ_HMC_FCN_ID_S 0
#define IRDMA_CQ_HMC_FCN_ID GENMASK_ULL(15, 0)
...
#define IRDMA_CQPSQ_PASID_S 32
#define IRDMA_CQPSQ_PASID GENMASK_ULL(51, 32)
#define IRDMA_CQPSQ_PASID_VALID_S 62
#define IRDMA_CQPSQ_PASID_VALID BIT_ULL(62)

/* Create/Modify/Destroy QP */

#define IRDMA_CQPSQ_QP_HMCFNIDX_S 0
#define IRDMA_CQPSQ_QP_HMCFNIDX GENMASK_ULL(15, 0)
...
#define IRDMA_CQPSQ_QP_USEHMCFNIDX_S 52
#define IRDMA_CQPSQ_QP_USEHMCFNIDX BIT_ULL(52)
...
#define IRDMA_MANAGE_RSRC_VER2_S 2
#define IRDMA_MANAGE_RSRC_VER2 BIT_ULL(2)
#define IRDMA_CQPSQ_RET_CQP_CMPL_HMC_FCN_ID_S 0
#define IRDMA_CQPSQ_RET_CQP_CMPL_HMC_FCN_ID GENMASK_ULL(15, 0)
#define IRDMA_CQPSQ_RET_CQP_CMPL_PEND_CMPL_S 42
#define IRDMA_CQPSQ_RET_CQP_CMPL_PEND_CMPL BIT_ULL(42)
#define IRDMA_CQPSQ_COPY_DATA_HMC_FCN_ID_S 0
#define IRDMA_CQPSQ_COPY_DATA_HMC_FCN_ID GENMASK_ULL(15, 0)
#define IRDMA_CQPSQ_COPY_DATA_LENGTH_S 0
#define IRDMA_CQPSQ_COPY_DATA_LENGTH GENMASK_ULL(15, 0)
...
#define IRDMA_CQPSQ_CQ_CQID_HIGH_S 50
#define IRDMA_CQPSQ_CQ_CQID_HIGH GENMASK_ULL(52, 50)
#define IRDMA_CQPSQ_CQ_CEQID_HIGH_S 54
...
#define IRDMA_CQPSQ_STAG_PDID_HI_S 56
#define IRDMA_CQPSQ_STAG_PDID_HI GENMASK_ULL(61, 56)
...
#define IRDMA_CQPSQ_STAG_NON_CACHED BIT_ULL(55)
...
#define IRDMA_CQPSQ_STAG_PASID_S 32
...
#define IRDMA_MAX_QSETS 16
#define IRDMA_INVALID_QS_HANDLE	0xffff
#define IRDMA_MAX_PUSH_PAGES_QSET 16
#define IRDMA_MULTI_QS_BIT BIT_ULL(0)
#define IRDMA_PUSH_ENA_BIT BIT_ULL(1)
#define IRDMA_NEED_PERIODIC_FLUSH_BIT BIT_ULL(2)
#define IRDMA_SKIP_ARP_BIT BIT_ULL(3)
#define IRDMA_SKIP_FLOW_LABEL_BIT BIT_ULL(4)
#define IRDMA_TEL_EVENTS_EN BIT_ULL(5)

#define IRDMA_CQPSQ_MPP_QS_HANDLE_S 0
#define IRDMA_CQPSQ_MPP_QS_HANDLE GENMASK_ULL(12, 0)
...
#define IRDMA_CQPSQ_MPP_HMC_FN_ID_S 0
#define IRDMA_CQPSQ_MPP_HMC_FN_ID GENMASK_ULL(15, 0)
#define IRDMA_CQPSQ_MPP_USE_HMC_FN_ID_S 55
#define IRDMA_CQPSQ_MPP_USE_HMC_FN_ID BIT_ULL(55)
#define IRDMA_CQPSQ_MPP_PAGE_TYPE_S 56
#define IRDMA_CQPSQ_MPP_PAGE_TYPE GENMASK_ULL(59, 56)
...
#define IRDMA_CQPSQ_UCTX_USE_HMC_FCN_ID_S 55
#define IRDMA_CQPSQ_UCTX_USE_HMC_FCN_ID BIT_ULL(55)
#define IRDMA_CQPSQ_UCTX_HMC_FCN_ID_S 0
#define IRDMA_CQPSQ_UCTX_HMC_FCN_ID GENMASK_ULL(15, 0)
...
#define IRDMA_CQPSQ_MHMC_SADOMAIN_S 16
#define IRDMA_CQPSQ_MHMC_SADOMAIN GENMASK_ULL(31, 16)
#define IRDMA_CQPSQ_MHMC_LOCALFENCE_S 41
#define IRDMA_CQPSQ_MHMC_LOCALFENCE BIT_ULL(41)
#define IRDMA_CQPSQ_MHMC_IGNOREPASIDCEQ_S 42
#define IRDMA_CQPSQ_MHMC_IGNOREPASIDCEQ BIT_ULL(42)
#define IRDMA_CQPSQ_MHMC_RDMABEHAVIOR_S 47
#define IRDMA_CQPSQ_MHMC_RDMABEHAVIOR BIT_ULL(47)
#define IRDMA_CQPSQ_MHMC_PASIDVALID_S 52
#define IRDMA_CQPSQ_MHMC_PASIDVALID BIT_ULL(52)
#define IRDMA_CQPSQ_MHMC_PROTFAM_S 48
#define IRDMA_CQPSQ_MHMC_PROTFAM GENMASK_ULL(51, 48)
#define IRDMA_CQPSQ_MHMC_PASID_S 0
#define IRDMA_CQPSQ_MHMC_PASID GENMASK_ULL(19, 0)
#define IRDMA_CQPSQ_MHMC_PFNUM_S 0
#define IRDMA_CQPSQ_MHMC_PFNUM GENMASK_ULL(5, 0)
#define IRDMA_CQPSQ_MHMC_HOST_ID_S 13
#define IRDMA_CQPSQ_MHMC_HOST_ID GENMASK_ULL(15, 13)

#define IRDMA_CQPSQ_MHMC_VMVFTYPE_VF 0
#define IRDMA_CQPSQ_MHMC_VMVFTYPE_VM 1
#define IRDMA_CQPSQ_MHMC_VMVFTYPE_PF 2
#define IRDMA_CQPSQ_MHMC_VMVFTYPE_S 8
#define IRDMA_CQPSQ_MHMC_VMVFTYPE GENMASK_ULL(9, 8)
...
#define IRDMA_CQPSQ_CEQ_CEQID_HIGH_S 10
...
#define IRDMA_CQPSQ_AH_HMCFNIDX_S 0
#define IRDMA_CQPSQ_AH_HMCFNIDX GENMASK_ULL(15, 0)
#define IRDMA_CQPSQ_AH_USEHMCFNIDX_S 52
#define IRDMA_CQPSQ_AH_USEHMCFNIDX BIT_ULL(52)
...
#define IRDMA_CQPSQ_FWQE_ERR_SQ_IDX_VALID_S 42
#define IRDMA_CQPSQ_FWQE_ERR_SQ_IDX_VALID BIT_ULL(42)
#define IRDMA_CQPSQ_FWQE_ERR_SQ_IDX_S 32
#define IRDMA_CQPSQ_FWQE_ERR_SQ_IDX GENMASK_ULL(49, 32)
#define IRDMA_CQPSQ_FWQE_ERR_RQ_IDX_VALID_S 43
#define IRDMA_CQPSQ_FWQE_ERR_RQ_IDX_VALID BIT_ULL(43)
#define IRDMA_CQPSQ_FWQE_ERR_RQ_IDX_S 32
...
#define IRDMA_CQPSQ_MAJ_RCA_FUNC_RESET_ERROR 0xF002
#define IRDMA_CQPSQ_MIN_RCA_FUNC_RESET_ERROR 0x0001
...
#define IRDMAQPC_USE_SRQ_S 10
#define IRDMAQPC_USE_SRQ BIT_ULL(10)
#define IRDMAQPC_RQ_PREFETCH_EN_S 11
#define IRDMAQPC_RQ_PREFETCH_EN BIT_ULL(11)
#define IRDMAQPC_SRQ_ID_S 0
#define IRDMAQPC_SRQ_ID GENMASK_ULL(15, 0)
#define IRDMAQPC_PASID_S 0
#define IRDMAQPC_PASID GENMASK_ULL(19, 0)
#define IRDMAQPC_PASID_VALID_S 11
...
#define IRDMAQPC_MINRNR_TIMER_S 0
...
#define IRDMAQPSQ_FAST_REG_PLACEMENT_TYPE_S 42
#define IRDMAQPSQ_FAST_REG_PLACEMENT_TYPE GENMASK_ULL(43, 42)
#define IRDMAQPSQ_FAST_REG_NON_CACHED_EN_S 58
#define IRDMAQPSQ_FAST_REG_NON_CACHED_EN BIT_ULL(58)
#define IRDMAQPSQ_BIND_MW_PLACEMENT_TYPE_S 42
#define IRDMAQPSQ_BIND_MW_PLACEMENT_TYPE GENMASK_ULL(43, 42)
#define IRDMAQPSQ_BIND_MW_NON_CACHED_EN_S 58
#define IRDMAQPSQ_BIND_MW_NON_CACHED_EN BIT_ULL(58)
...
#define IRDMA_QUERY_FPM_MAX_PE_SDS_GEN3_S 32
#define IRDMA_QUERY_FPM_MAX_PE_SDS_GEN3 GENMASK_ULL(47, 32)
#define IRDMA_QUERY_FPM_MAX_IRD_S 50
...
enum irdma_sys_stats_type {
	IRDMA_SYS_STAT_TYPE_GLOBAL_STATS,
	IRDMA_SYS_STAT_TYPE_LATENCY_HISTOGRAM,
	IRDMA_SYS_STAT_TYPE_TRANSMIT_UPPER_PIPELINE_MONITOR_STATS,
	IRDMA_SYS_STAT_TYPE_OBJECT_CACHE_STATS,
	IRDMA_SYS_STAT_TYPE_OP_LATENCY_PER_VF_HISTOGRAM,
};

#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_STATS_TYPE_S 8
#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_STATS_TYPE GENMASK_ULL(11, 8)
#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_STATS_SUBTYPE_S 0
#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_STATS_SUBTYPE GENMASK_ULL(4, 0)
#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_VF_COUNT_S 16
#define IRDMA_CQPSQ_GATHER_RDMA_SYSTEM_STATS_VF_COUNT GENMASK_ULL(20, 16)

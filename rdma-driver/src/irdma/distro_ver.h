...
#if SLE_LOCALVERSION_CODE >= SLE_LOCALVERSION(150700ULL, 0, 0)
#define SLES_15_SP_7
#elif SLE_LOCALVERSION_CODE >= SLE_LOCALVERSION(150600ULL, 0, 0)
#define SLES_15_SP_6
...
#if (UBUNTU_VERSION_CODE >= UBUNTU_VERSION(6, 17, 0, 14))
#define UBUNTU_240404
#elif (UBUNTU_VERSION_CODE >= UBUNTU_VERSION(6, 14, 0, 24))
...
#elif (UBUNTU_VERSION_CODE >= UBUNTU_VERSION(5, 4, 0, 144))
#define UBUNTU_200406
